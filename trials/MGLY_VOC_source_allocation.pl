...
$R->run(q` my.colours = c( "Methane" = "#c9a415", "Ethane" = "#ae4901", "Propane" = "#86b650", "Butane" = "#76afca", "2-Methylpropane" = "#dc3522", "Pentane" = "#6c254f", "2-Methylbutane" = "#9bb08f", "Hexane" = "#8b1537", "Heptane" = "#ba8b01", "Octane" = "#0352cb", "Ethene" = "#86b650", "Propene" = "#6c254f", "Butene" = "#ee6738", "2-Methylpropene" = "#58691b", "Isoprene" = "#8ed6d5", "Benzene" = "#f3aa7f", "Toluene" = "#ef6638", "m-Xylene" = "#0e5c28", "o-Xylene" = "#f8c500", "p-Xylene" = "#b569b3", "Ethylbenzene" = "#2c9def", "Others" = "#696537" ) `,
