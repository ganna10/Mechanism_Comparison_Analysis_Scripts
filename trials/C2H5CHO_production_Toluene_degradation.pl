#! /usr/bin/env perl
# C2H5CHO production contributions during Toluene degradation in CRI and RACM2
...
$R->run(q` my.colours = c(  "C2H5O" = "#6c254f", "C2H5CHO + NO" = "#6c254f", "RCO3 + NO" = "#6c254f",
                            "Production Others" = "#623812",
                            "HC3P + NO" = "#000000",
                            "NO + RCO3" = "#f9c500", "C2H5CHO + NO" = "#f9c500",
...
$R->run(q` CairoPDF(file = "Toluene_C2H5CHO_production_contributors.pdf") `,
        q` print(plot) `,
        q` dev.off() `,
);
