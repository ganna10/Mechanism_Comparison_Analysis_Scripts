#! /usr/bin/perl
# Analyse day-time radical budget during Toluene breakdown, compare for all mechanisms - stacked bar plot, individual reactions
# Version 0: Jane Coates 24/07/2014
...
my $mcm_3_2_ro2file = "/local/home/coates/MECCA/MCM_3.2_tagged/RO2_species.txt";
my @mcm_3_2_no2_reservoirs = get_no2_reservoirs($mcm_3_2_kpp, $mcm_3_2_ro2file);
my $mcm_3_2_radical_file = "/local/home/coates/MECCA/MCM_3.2_tagged/radicals.txt";
my @mcm_3_2_radicals = get_radicals($mcm_3_2_radical_file);
my $mcm_3_2_pan_file = "/local/home/coates/MECCA/MCM_3.2_tagged/All_pans.txt";
...
#mcm 3.1
my $mcm_3_1_run = "/local/home/coates/MECCA/MCM_3.1_tagged_3.2rates/boxmodel";
my $mcm_3_1_mecca = MECCA->new($mcm_3_1_run); 
my $mcm_3_1_eqnfile = "/local/home/coates/MECCA/MCM_3.1_tagged_3.2rates/gas.eqn";
my $mcm_3_1_kpp = KPP->new($mcm_3_1_eqnfile); 
my $mcm_3_1_ro2file = "/local/home/coates/MECCA/MCM_3.1_tagged_3.2rates/RO2_species.txt";
my @mcm_3_1_no2_reservoirs = get_no2_reservoirs($mcm_3_1_kpp, $mcm_3_1_ro2file);
my $mcm_3_1_radical_file = "/local/home/coates/MECCA/MCM_3.1_tagged_3.2rates/radicals.txt";
my @mcm_3_1_radicals = get_radicals($mcm_3_1_radical_file);
my $mcm_3_1_pan_file = "/local/home/coates/MECCA/MCM_3.1_tagged_3.2rates/All_pans.txt";
...
my $cri_ro2file = "/local/home/coates/MECCA/CRI_tagging/RO2_species.txt";
my @cri_no2_reservoirs = get_no2_reservoirs($cri_kpp, $cri_ro2file);
my $cri_radical_file = "/local/home/coates/MECCA/CRI_tagging/radicals.txt";
my @cri_radicals = get_radicals($cri_radical_file);
my $cri_pan_file = "/local/home/coates/MECCA/CRI_tagging/All_pans.txt";
...
#mozart
my $mozart_run = '/local/home/coates/MECCA/MOZART_tagging/boxmodel';
my $mozart_mecca = MECCA->new($mozart_run);
my $mozart_eqnfile = '/local/home/coates/MECCA/MOZART_tagging/gas.eqn';
my $mozart_kpp = KPP->new($mozart_eqnfile);
my $mozart_ro2file = "/local/home/coates/MECCA/MOZART_tagging/RO2_species.txt";
my @mozart_no2_reservoirs = get_no2_reservoirs($mozart_kpp, $mozart_ro2file);
my $mozart_radical_file = "/local/home/coates/MECCA/MOZART_tagging/radicals.txt";
my @mozart_radicals = get_radicals($mozart_radical_file);
my $mozart_pan_file = "/local/home/coates/MECCA/MOZART_tagging/All_pans.txt";
my @mozart_pans = get_radicals($mozart_pan_file);
$families{'radicals_mozart'} = [ @mozart_radicals, @mozart_no2_reservoirs, 'HONO', 'HO2NO2' ];
($production_rates{'radicals_mozart'}, $consumption_rates{'radicals_mozart'}) = get_rates($species[0], 'radicals_mozart', $mozart_kpp, $mozart_mecca, \@mozart_radicals, \@mozart_pans);
...
#radm2
my $radm2_run = '/local/home/coates/MECCA/RADM2_tagged/boxmodel';
my $radm2_mecca = MECCA->new($radm2_run);
my $radm2_eqnfile = '/local/home/coates/MECCA/RADM2_tagged/gas.eqn';
my $radm2_kpp = KPP->new($radm2_eqnfile);
my $radm2_ro2file = "/local/home/coates/MECCA/RADM2_tagged/RO2_species.txt";
my @radm2_no2_reservoirs = get_no2_reservoirs($radm2_kpp, $radm2_ro2file);
my $radm2_radical_file = "/local/home/coates/MECCA/RADM2_tagged/radicals.txt";
my @radm2_radicals = get_radicals($radm2_radical_file);
my $radm2_pan_file = "/local/home/coates/MECCA/RADM2_tagged/All_pans.txt";
my @radm2_pans = get_radicals($radm2_pan_file);
$families{'radicals_radm2'} = [ @radm2_radicals, @radm2_no2_reservoirs, 'HONO', 'HO2NO2' ];
($production_rates{'radicals_radm2'}, $consumption_rates{'radicals_radm2'}) = get_rates($species[1], 'radicals_radm2', $radm2_kpp, $radm2_mecca, \@radm2_radicals, \@radm2_pans);
...
#racm
my $racm_run = '/local/home/coates/MECCA/RACM_tagging/boxmodel';
my $racm_mecca = MECCA->new($racm_run);
my $racm_eqnfile = '/local/home/coates/MECCA/RACM_tagging/gas.eqn';
my $racm_kpp = KPP->new($racm_eqnfile);
my $racm_ro2file = "/local/home/coates/MECCA/RACM_tagging/RO2_species.txt";
my @racm_no2_reservoirs = get_no2_reservoirs($racm_kpp, $racm_ro2file);
my $racm_radical_file = "/local/home/coates/MECCA/RACM_tagging/radicals.txt";
my @racm_radicals = get_radicals($racm_radical_file);
my $racm_pan_file = "/local/home/coates/MECCA/RACM_tagging/All_pans.txt";
my @racm_pans = get_radicals($racm_pan_file);
$families{'radicals_racm'} = [ @racm_radicals, @racm_no2_reservoirs, 'HONO', 'HO2NO2' ];
($production_rates{'radicals_racm'}, $consumption_rates{'radicals_racm'}) = get_rates($species[1], 'radicals_racm', $racm_kpp, $racm_mecca, \@racm_radicals, \@racm_pans);
...
my $racm2_ro2file = "/local/home/coates/MECCA/RACM2_tagged/RO2_species.txt";
my @racm2_no2_reservoirs = get_no2_reservoirs($racm2_kpp, $racm2_ro2file);
my $racm2_radical_file = "/local/home/coates/MECCA/RACM2_tagged/radicals.txt";
my @racm2_radicals = get_radicals($racm2_radical_file);
my $racm2_pan_file = "/local/home/coates/MECCA/RACM2_tagged/All_pans.txt";
my @racm2_pans = get_radicals($racm2_pan_file);
$families{'radicals_racm2'} = [ @racm2_radicals, @racm2_no2_reservoirs, 'HONO', 'HO2NO2' ];
($production_rates{'radicals_racm2'}, $consumption_rates{'radicals_racm2'}) = get_rates($species[1], 'radicals_racm2', $racm2_kpp, $racm2_mecca, \@racm2_radicals, \@racm2_pans);
...
#CBM-IV
my $cbm4_run = "/local/home/coates/MECCA/CBM4_tagging/boxmodel";
my $cbm4_mecca = MECCA->new($cbm4_run);
my $cbm4_eqnfile = "/local/home/coates/MECCA/CBM4_tagging/gas.eqn";
my $cbm4_kpp = KPP->new($cbm4_eqnfile);
my $cbm4_ro2file = "/local/home/coates/MECCA/CBM4_tagging/RO2_species.txt";
my @cbm4_no2_reservoirs = get_no2_reservoirs($cbm4_kpp, $cbm4_ro2file);
my $cbm4_radical_file = "/local/home/coates/MECCA/CBM4_tagging/radicals.txt";
my @cbm4_radicals = get_radicals($cbm4_radical_file);
my $cbm4_pan_file = "/local/home/coates/MECCA/CBM4_tagging/All_pans.txt";
...
#CB05
my $cb05_run = "/local/home/coates/MECCA/CB05_tagging/boxmodel";
my $cb05_mecca = MECCA->new($cb05_run);
my $cb05_eqnfile = "/local/home/coates/MECCA/CB05_tagging/gas.eqn";
my $cb05_kpp = KPP->new($cb05_eqnfile);
my $cb05_ro2file = "/local/home/coates/MECCA/CB05_tagging/RO2_species.txt";
my @cb05_no2_reservoirs = get_no2_reservoirs($cb05_kpp, $cb05_ro2file);
my $cb05_radical_file = "/local/home/coates/MECCA/CB05_tagging/radicals.txt";
my @cb05_radicals = get_radicals($cb05_radical_file);
my $cb05_pan_file = "/local/home/coates/MECCA/CB05_tagging/All_pans.txt";
...
sub plot { #create dataframe and then create plot
    ...
    $R->run(q` my.colours = c( "Photolysis" = "#76afca", "Radical Reactions Production" = "#ef6638", "PAN Family + Organic Nitrate Deposition" = "#898989", "Non-Radical Reactions Production" = "#eb569b3", "VOC Initial Oxidation" = "#dc3522", "Radical Reactions Consumption" = "#f9c500", "Non-Radical Reactions Consumption" = "#cc6329" ) `,
);
    ...
    $R->run(q` mech.plot = function(data, plot.title, plot.legend) {data = ddply(data, .(time), colwise(sum)) ;
                                                                    ...
                                                                    plot = plot + scale_y_continuous(limits = c(-100, 100), breaks = seq(-100, 100, 20)) ;
    ...
    $R->run(q` cb05.plot = mech.plot(cb05.data, cb05.plot.title, cb05.legend) `);
     ...
     $R->run(q` CairoPDF(file = "toluene_radical_budget_breakdown.pdf", width = 210, height = 200) `, 
