#! /usr/bin/env perl
# CH3O2 production contributions during TOLUENE degradation in MCM v3.2 and MOZART
# Version 0: Jane Coates 2/2/2015 looking at MCM v3.2 and CBs
...
$R->run(q` CairoPDF(file = "TOLUENE_CH3O2_production_contributors.pdf") `,
        q` print(plot) `,
        q` dev.off() `,
);
