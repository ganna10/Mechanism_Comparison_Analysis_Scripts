...
radm2.data = data.frame(TOPP = c(0.342958648488, 1.67143841991616, 1.5708976838747, 1.58514964596511, 1.99016983776016, 2.01276544767989, 1.87340886945383, 1.74628670267072, 2.64668250083923), C = c(2, 3, 4, 4, 5, 5, 6, 7, 8),Mechanism = rep("RADM2", 9), VOC = c("Ethane", "Propane", "Butane", "2-methylpropane", "Pentane", "2-methylbutane", "Hexane", "Heptane", "Octane"))
racm.data = data.frame(TOPP = c(0.329033464193, 1.49119046317878, 1.40149204236976, 1.4142070725483, 2.05412249571477, 2.07744419909902, 1.93360949874895, 1.80240235374113, 2.16452836990356), C = c(2, 3, 4, 4, 5, 5, 6, 7, 8), Mechanism = rep("RACM", 9), VOC = c("Ethane", "Propane", "Butane", "2-methylpropane", "Pentane", "2-methylbutane", "Hexane", "Heptane", "Octane"))
