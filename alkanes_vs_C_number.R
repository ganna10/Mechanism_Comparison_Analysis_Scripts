...
mozart.data = data.frame(TOPP = c(0.13925464451313, 0.426944702863693, 1.35161006016234, 1.36120154967707, 1.25415044979106, 1.26796579809986, 1.19147772506108, 1.13707226810293, 1.07097521526232), C = c(2, 3, 4, 4, 5, 5, 6, 7, 8),Mechanism = rep("MOZART-4", 9), VOC = c("Ethane", "Propane", "Butane", "2-methylpropane", "Pentane", "2-methylbutane", "Hexane", "Heptane", "Octane"))
radm2.data = data.frame(TOPP = c(0.128240107806014, 1.08334165767495, 1.018176249037, 1.02741364842436, 1.6082770856021, 1.62653683458413, 1.51392132447213, 1.41119257035762, 2.64668250083923), C = c(2, 3, 4, 4, 5, 5, 6, 7, 8),Mechanism = rep("RADM2", 9), VOC = c("Ethane", "Propane", "Butane", "2-methylpropane", "Pentane", "2-methylbutane", "Hexane", "Heptane", "Octane"))
racm.data = data.frame(TOPP = c(0.131782606244087, 0.874435728469489, 0.821836475805618, 0.829292583493552, 1.5196495628324, 1.53690306958592, 1.43049347621303, 1.3334258081613, 2.16452836990356), C = c(2, 3, 4, 4, 5, 5, 6, 7, 8), Mechanism = rep("RACM", 9), VOC = c("Ethane", "Propane", "Butane", "2-methylpropane", "Pentane", "2-methylbutane", "Hexane", "Heptane", "Octane"))
racm2.data = data.frame(TOPP = c(0.11060257256031, 0.798908760167675, 0.750852622519925, 0.757664729521855, 1.24206785895999, 1.25616981161871, 1.16919717065856, 1.08986004348133, 2.49343633651733), C = c(2, 3, 4, 4, 5, 5, 6, 7, 8), Mechanism = rep("RACM2", 9), VOC = c("Ethane", "Propane", "Butane", "2-methylpropane", "Pentane", "2-methylbutane", "Hexane", "Heptane", "Octane"))
