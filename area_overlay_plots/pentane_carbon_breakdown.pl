#! /usr/bin/perl
# Analyse number of Carbon atoms per radical produced during Pentane breakdown, compare for all mechanisms
...
sub plot { #create dataframe and then create plot
    ...
    $R->run(q` CairoPDF(file = "pentane_carbon_breakdown.pdf", width = 100, height = 90) `,
