#!/usr/bin/perl
# Version 0 : Jane Coates 19/02/2014 PAN budget plot attributed back to the parent VOCs
...
sub budget_plot { #create dataframe and then create plot
    ...
    $R->run(q` my.names = c( "CH4" = "Methane", "C2H6" = "Ethane", "C3H8" = "Propane", "NC4H10" = "Butane", "IC4H10" = "2-Methylpropane", "NC5H12" = "Pentane", "IC5H12" = "2-Methylbutane", "NC6H14" = "Hexane", "NC7H16" = "Heptane", "NC8H18" = "Octane", "C2H4" = "Ethene", "C3H6" = "Propene", "BUT1ENE" = "Butene", "MEPROPENE" = "2-Methylpropene", "C5H8" = "Isoprene", "BENZENE" = "Benzene", "TOLUENE" = "Toluene", "MXYL" = "m-Xylene", "OXYL" = "o-Xylene", "PXYL" = "p-Xylene", "EBENZ" = "Ethylbenzene", "BIGALK" = "Pentane", "BIGENE" = "Butene", "ISOP" = "Isoprene", "ISO" = "Isoprene", "ETH" = "Ethane", "HC3" = "Propane", "HC5" = "Pentane", "HC8" = "Octane", "OL2" = "Ethene", "OLT" = "Propene", "OLI" = "2-Methylpropene", "TOL" = "Toluene", "XYL" = "m-Xylene", "ETE" = "Ethene", "BEN" = "Benzene", "XYM" = "m-Xylene", "XYO" = "o-Xylene", "XYP" = "p-Xylene" ) `,
            q` my.colours = c( "Production Others" = "#696537", "NC7H16" = "#f9c600", "EBENZ" = "#76afca", "BENZENE" = "#dc3522", "BEN" = "#dc3522", "OXYL" = "#8c6238", "XYO" = "#8c6238", "PXYL" = "#9bb08f", "XYP" = "#9bb08f", "NC6H14" = "#8b1537", "IC4H10" = "#e7e85e", "C3H6" = "#0352cb", "OLT" = "#0352cb", "C2H6" = "#86b650", "ETH" = "#86b650", "MXYL" = "#6c254f", "XYL" = "#6c254f", "XYM" = "#6c254f", "C5H8" = "#ee6738","ISOP" = "#ee6738",  "ISO" = "#ee6738", "C2H4" = "#58691b", "OL2" = "#58691b", "ETE" = "#58691b", "NC5H12" = "#8ed6d5", "HC5" = "#8ed6d5", "BIGALK" = "#8ed6d5", "C3H8" = "#f3aa7f", "OLT" = "#f3aa7f", "TOLUENE" = "#c65d6c", "TOL" = "#c65d6c", "NC4H10" = "#888a87", "IC5H12" = "#0e5c28", "CH4" = "#b569b3", "H2O2 + hv = OH + OH" = "#2c9def", "HONO + hv = NO + OH" = "#898989", "HONO + hv = OH + NO" = "#898989", "O1D = OH + OH" = "#ae4903", "NO2 + OH = HNO3" = "#b569b3", "OH + NO2 = HNO3" = "#b569b3", "HO2 + HO2 = H2O2" = "#0e5c28", "NO + OH = HONO" = "#f8c56c", "OH + NO = HONO" = "#f8c56c", "HO2 + OH = UNITY" = "#0c3f78", "OH + HO2 = UNITY" = "#0c3f78", "HNO3 + OH = NO3" = "#a67c52", "Consumption Others" = "#6c254f", "BUT1ENE" = "#86b650", "BIGENE" = "#86b650", "MEPROPENE" = "#ae4903", "OLI" = "#ae4903", "NC8H18" = "#be2448", "HC8" = "#be2448", "C3H8" = "#f8c56c", "HC3" = "#f8c56c" ) `,
    ...
    $R->run(q` mcm3.1.plot = mech.plot.onlypos(mcm3.1.data, "MCM v3.1", mcm3.1.plot.title, mcm3.1.legend) `);
     ...
     $R->run(q` mcm3.2.plot = mech.plot.onlypos(mcm3.2.data, "MCM v3.2", mcm3.2.plot.title, mcm3.2.legend) `);
     ...
     $R->run(q` cri.plot = mech.plot.onlypos(cri.data, "CRI v2", cri.plot.title, cri.legend) `);
     ...
     $R->run(q` radm2.plot = mech.plot.onlypos(radm2.data, "RADM2", radm2.plot.title, radm2.legend) `);
     ...
     $R->run(q` racm.plot = mech.plot.onlypos(racm.data, "RACM", racm.plot.title, racm.legend) `);
     ...
     $R->run(q` racm2.plot = mech.plot.onlypos(racm2.data, "RACM2", racm2.plot.title, racm2.legend) `);
    ...
    $R->run(q` cbm4.plot = mech.plot.onlypos(cbm4.data, "CBM-IV", cbm4.plot.title, cbm4.legend) `);
    ...
    $R->run(q` cb05.plot = mech.plot.onlypos(cb05.data, "CB05", cb05.plot.title, cb05.legend) `);

    $R->run(q` CairoPDF(file = "PAN_overall_budgets.pdf", width = 190, height = 200) `, 
            ...
            q` main.plot = grid.arrange(y.label, 
                                        arrangeGrob(mcm3.2.plot + theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), legend.position = c(0.85, 0.75)), 
                                                    mcm3.1.plot + theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank(), legend.position = c(0.85, 0.78)), 
                                                    cri.plot + theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank(), legend.position = c(0.85, 0.72)), 
                                                    radm2.plot + theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), legend.position = c(0.85, 0.85)), 
                                                    racm.plot + theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank(), legend.position = c(0.85, 0.85)), 
                                                    racm2.plot + theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_blank(), axis.ticks.y = element_blank(), legend.position = c(0.85, 0.73)), 
                                                    mozart.plot + theme(legend.position = c(0.85, 0.85)), 
                                                    cbm4.plot + theme(axis.text.y = element_blank(), axis.ticks.y = element_blank(), legend.position = c(0.85, 0.78)), 
                                                    cb05.plot + theme(axis.text.y = element_blank(), axis.ticks.y = element_blank(), legend.position = c(0.85, 0.75)), 
                                                    nrow = 3), 
                                       nrow = 1, 
