...
$R->set('rep.number', scalar(keys %TOPP));
...
$R->run(q` plot1 = ggplot(data = subset(data, NMVOC == "C2H6" | NMVOC == "C3H8" | NMVOC == "NC4H10" | NMVOC == "IC4H10" | NMVOC == "NC5H12"), aes(x = times, y = TOPP.value, colour = Mechanism)) `,
